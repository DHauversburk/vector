  ...
  return (
    <div className="min-h-screen min-h-[100dvh] relative flex flex-col items-center justify-center p-6 bg-slate-950 overscroll-none overflow-y-auto">
      ...
      <div className="w-full max-w-lg relative z-10 my-auto">
        {/* Logo */}
        <div
          className={`text-center mb-8 transition-all duration-500 ${isLoaded('logo') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
        >
        ...
        {/* Title */}
        <div
          className={`text-center mb-10 transition-all duration-500 ${isLoaded('title') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
        >
        ...
        <div
          className={`space-y-4 mb-8 transition-all duration-500 ${isLoaded('cards') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
        >
          {entryPoints.map((entry) => {
            ...
            return (
              ...
              >
                ...
                {/* Icon */}
                <div
                  className={`w-12 h-12 rounded-xl bg-gradient-to-br ${entry.gradient} flex items-center justify-center flex-shrink-0 shadow-lg`}
                >
                ...
                <div className="flex-1 text-left min-w-0">
                  <h2 className="text-base font-bold text-white mb-0.5">{entry.title}</h2>
                ...
                {/* Arrow */}
                <ChevronRight
                  className={`w-5 h-5 text-slate-500 flex-shrink-0 transition-transform duration-200 ${isHovered ? 'translate-x-1 text-white' : ''}`}
                />
              </button>
            )
          })}
        ...
        {/* Capabilities Grid */}
        <div
          className={`mt-12 grid grid-cols-2 gap-4 transition-all duration-700 delay-500 ${isLoaded('footer') ? 'opacity-100' : 'opacity-0'}`}
        >
          <div className="p-4 rounded-xl border border-slate-800 bg-slate-900/40 backdrop-blur-sm">
            ...
            <h3 className="text-[10px] font-black uppercase text-white tracking-widest mb-1">
              Resilient Sync
            </h3>
            <p className="text-[9px] font-bold text-slate-500 leading-relaxed uppercase">
              Tactical outbox for signal-denied clinical entry.
            </p>
          </div>
          <div className="p-4 rounded-xl border border-slate-800 bg-slate-900/40 backdrop-blur-sm">
            ...
            <p className="text-[9px] font-bold text-slate-500 leading-relaxed uppercase">
              Native biometric layer for session security.
            </p>
          </div>
          <div className="p-4 rounded-xl border border-slate-800 bg-slate-900/40 backdrop-blur-sm">
            ...
            <p className="text-[9px] font-bold text-slate-500 leading-relaxed uppercase">
              Optimized scheduling for high-density units.
            </p>
          </div>
          <div className="p-4 rounded-xl border border-slate-800 bg-slate-900/40 backdrop-blur-sm">
            ...
            <p className="text-[9px] font-bold text-slate-500 leading-relaxed uppercase">
              Real-time diagnostics and member resources.
            </p>
          </div>
        </div>
        ...
        {/* Help Link & Footer */}
        <div
          className={`mt-12 text-center transition-all duration-500 ${isLoaded('footer') ? 'opacity-100' : 'opacity-0'}`}
        >
          <button
