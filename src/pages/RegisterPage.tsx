...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-4 font-sans selection:bg-indigo-100 relative transition-colors">
      ...
      <div className="w-full max-w-[480px] space-y-8 relative z-10 px-4">
        <div className="text-center space-y-4">
          ...
          <div className="space-y-1">
            <h1 className="text-xl font-black text-slate-900 dark:text-white tracking-[0.2em] uppercase">
              Patient Registration
            </h1>
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
              Enroll in VECTOR Healthcare
            </p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[2rem] shadow-2xl p-8 space-y-6 shadow-slate-200/50 dark:shadow-none transition-colors">
          {error && (
            <div
              role="alert"
              className="flex items-start gap-3 p-3 bg-red-50 border border-red-100 rounded text-red-700 animate-in fade-in zoom-in-95"
            >
