  ...
  member: [
    {
      ...
      description:
        "This is your secure patient portal. Let's take a quick tour to help you get started.",
      position: 'bottom',
    },
    {
      id: 'nav-overview',
  ...
  provider: [
    {
      ...
      description:
        "This is your clinical management dashboard. Let's explore your tools for managing appointments and patient care.",
      position: 'bottom',
    },
    {
      id: 'nav-overview',
      ...
      title: 'Dashboard Overview',
      description:
        "Your home base. See today's schedule, upcoming appointments, and quick stats at a glance.",
      position: 'right',
    },
    {
      id: 'nav-schedule',
      ...
      description:
        'Create and manage your availability. Use Auto-Generate to quickly create slots for multiple days.',
      position: 'right',
    },
    {
      id: 'nav-patients',
      ...
      title: '👥 Patient List',
      description:
        'View all your assigned patients and their appointment history. Generate new patient tokens here.',
      position: 'right',
    },
    {
      id: 'nav-logs',
    ...
    },
    {
      ...
      description:
        'Track your appointment metrics, completion rates, and patient satisfaction scores.',
      position: 'right',
    },
    {
      id: 'nav-security',
    ...
    },
    {
      ...
      title: '⚡ Quick Notes',
      description:
        'Click this button anytime to create a quick clinical note. Notes are encrypted and stored securely.',
      position: 'left',
    },
    {
      id: 'feedback',
      ...
      title: '💬 Beta Feedback',
      description:
        'Help us improve! Share your feedback on the interface, features, or any issues you encounter.',
      position: 'left',
    },
  ],
  admin: [
...
interface OnboardingContextType {
  ...
  skipTour: () => void
  completeTour: () => void
  markTourCompleted: (role: string) => void
...
export function OnboardingProvider({ children }: { children: ReactNode }) {
  ...
  const markTourCompleted = useCallback((role: string) => {
    setCompletedTours((prev) => new Set([...prev, role]))
  }, [])
