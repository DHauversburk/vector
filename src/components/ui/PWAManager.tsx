...
export function PWAManager() {
  ...
  useEffect(() => {
    if (needRefresh) {
      toast.info('Update available', {
        description: 'A new version of VECTOR is ready.',
        action: {
          label: 'Update',
  ...
  return (
    <>
      ...
      <div
        className={`fixed bottom-6 left-1/2 -translate-x-1/2 z-[100] transition-all duration-500 transform ${isOnline ? 'translate-y-20 opacity-0' : 'translate-y-0 opacity-100'}`}
      >
