    ...
    >
      ...
      >
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <div className="text-[9px] font-bold opacity-60">
                    Keep modal open for back-to-back notes
                  </div>
                </div>
              </div>
              <div
                className={`w-8 h-4 rounded-full relative transition-colors ${keepOpen ? 'bg-indigo-500' : 'bg-slate-700'}`}
              >
                <div
                  className={`absolute top-0.5 w-3 h-3 rounded-full bg-white transition-all ${keepOpen ? 'left-4.5' : 'left-0.5'}`}
                />
              </div>
            </button>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <div className="text-[9px] font-bold opacity-60">
                    Create an appointment from this note
                  </div>
                </div>
              </div>
              <div
                className={`w-8 h-4 rounded-full relative transition-colors ${scheduleFollowUp ? 'bg-emerald-500' : 'bg-slate-700'}`}
              >
                <div
                  className={`absolute top-0.5 w-3 h-3 rounded-full bg-white transition-all ${scheduleFollowUp ? 'left-4.5' : 'left-0.5'}`}
                />
              </div>
            </button>
        ...
        <div className="p-6 pt-0 flex gap-3">
          ...
          <Button onClick={handleSubmit} variant="gradient" className="flex-1" disabled={loading}>
            {loading ? (
              <>
