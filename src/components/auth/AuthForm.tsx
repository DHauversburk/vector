    ...
    return (
        <div role="region" aria-label="Authentication Form">
            ...
            <div className={`transition-all duration-500 delay-100 ${isLoaded('inputs') ? 'opacity-100' : 'opacity-0'}`}>
                <div role="tablist" className="flex bg-slate-950/80 p-1 rounded-xl border border-slate-800 mb-8" aria-label="Login method">
                    <button
                        type="button"
                        role="tab"
                    ...
                    {mode === 'email' ? (
                        <div className="space-y-5">
                            <div className="space-y-2">
                                <label htmlFor={emailId} className="text-xs font-black uppercase tracking-widest text-slate-400">
                                    Email Address
                                </label>
                                <Input
                                    id={emailId}
                            ...
                            <div className="space-y-2">
                                <label htmlFor={passwordId} className="text-xs font-black uppercase tracking-widest text-slate-400">
                                    Password
                                </label>
                                <Input
                                    id={passwordId}
                        ...
                        <div className="space-y-6">
                            <div className="space-y-3">
                                <label htmlFor={tokenId} className="text-sm font-black uppercase tracking-widest text-center block text-slate-300">
                                    Clinical Identity Token
                                </label>
                                <div className="relative group">
                                    <div className="absolute -inset-1 vector-gradient rounded-xl blur opacity-25 group-focus-within:opacity-50 transition-opacity" aria-hidden="true" />
                                    <div className="relative">
                                        ...
                                        />
                                        <Key className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-600 w-5 h-5" aria-hidden="true" />
                                    </div>
                                </div>
                                <button
                                    type="button"
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                >
                                    <div className="w-12 h-12 rounded-xl bg-slate-800/50 flex items-center justify-center mb-3 group-hover:bg-blue-900/30 transition-colors">
                                        <QrCode className="w-6 h-6 text-slate-500 group-hover:text-blue-400 transition-colors" aria-hidden="true" />
                                    </div>
                                ...
                                >
                                    <div className="w-12 h-12 rounded-xl bg-slate-800/50 flex items-center justify-center mb-3 group-hover:bg-emerald-900/30 transition-colors">
                                        <Fingerprint className="w-6 h-6 text-slate-500 group-hover:text-emerald-400 transition-colors" aria-hidden="true" />
                                    </div>
                                    <span className="text-[10px] font-black uppercase tracking-widest text-slate-500 group-hover:text-slate-300 transition-colors">
                                        Biometric
                                    </span>
