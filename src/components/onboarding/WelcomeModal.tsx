...
export function WelcomeModal({ role, userName }: WelcomeModalProps) {
  const { hasCompletedTour, startTour, markTourCompleted } = useOnboarding()
  ...
  const roleConfig = {
    member: {
      ...
      description:
        'This is your personal patient portal. You can book appointments, manage your schedule, and access care — all while maintaining complete privacy.',
    ...
    provider: {
      ...
      description:
        'Manage your schedule, view patient appointments, and handle waitlist requests all in one place.',
    ...
    admin: {
      ...
      description:
        "Full control over tokens, schedules, and system health. Let's make sure you know where everything is.",
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
      ...
      >
        {/* Gradient Header */}
        <div
          className={cn('relative p-8 pb-12 text-center', `bg-gradient-to-br ${config.gradient}`)}
        >
