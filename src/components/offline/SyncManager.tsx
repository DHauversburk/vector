            ...
            <div className="bg-white dark:bg-slate-900 w-full max-w-2xl rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden flex flex-col max-h-[85vh]">
                ...
                <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between bg-slate-50/50 dark:bg-slate-900/50">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-tight">Tactical Mutation Queue</h2>
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-4 custom-scrollbar">
                    {items.length === 0 ? (
                        <div className="py-20 flex flex-col items-center justify-center text-center">
                            ...
                            <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest">Local Outbox Empty</h3>
                            <p className="text-[10px] text-slate-500 uppercase font-bold mt-1">All changes are synchronized with central command.</p>
                        </div>
                    ) : (
                        items.map((item) => (
                            <div 
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center gap-3 mb-1">
                                        <span className={cn(
                                            ...
                                            item.status === 'syncing' ? "bg-indigo-500 text-white" : "bg-slate-100 dark:bg-slate-800 text-slate-500"
                                        )}>
                                            {item.status}
                                        </span>
                ...
                <div className="px-6 py-4 bg-slate-100 dark:bg-slate-950 flex items-center justify-center gap-4">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[8px] font-black text-slate-500 uppercase tracking-[0.2em]">FIPS-140 Zero-Trust Persistence Layer</span>
                    </div>
                </div>
            </div>
        </div>
