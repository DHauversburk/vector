...
import { 
    FileText, MessageSquare, UserCheck, Calendar, Settings,
    HelpCircle, AlertTriangle, Clock, CheckCircle, User, 
    ArchiveRestore, Archive, ChevronRight, type LucideIcon 
} from 'lucide-react';
...
export function EncounterRow({ note, style, handleStatusChange, handleArchive, handleUnarchive }: EncounterRowProps) {
