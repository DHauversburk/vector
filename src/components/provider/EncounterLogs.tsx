...
import {
    ...
    Download, Archive, AlertTriangle
} from 'lucide-react';
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <StatCard icon={AlertTriangle} label="Needs Action" value={stats.actionRequiredCount} color="amber" />
...
function EmptyState({ showArchived }: { showArchived: boolean }) {
    return (
        <div className="p-20 text-center bg-white dark:bg-slate-900 rounded-3xl border border-dashed border-slate-200 dark:border-slate-800">
            ...
            <h3 className="text-base font-black uppercase tracking-widest text-slate-900 dark:text-white mb-2">No Clinical Records Found</h3>
