  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
      <div
        ...
        role="dialog"
        aria-modal="true"
        className="bg-white dark:bg-slate-900 rounded-xl shadow-2xl w-full max-w-2xl border border-slate-200 dark:border-slate-800 overflow-hidden"
      >
        <div className="p-6 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center bg-slate-50 dark:bg-slate-950">
          <div>
            ...
            <p className="text-xs text-slate-500 font-medium">
              Bulk create slots for your schedule
            </p>
          </div>
          <button
            onClick={onClose}
          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <label
                  htmlFor="blockMode"
                  className="text-xs font-bold text-slate-700 dark:text-slate-300 select-none cursor-pointer"
                >
