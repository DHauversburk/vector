  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-sm p-4 animate-in fade-in">
      <div
        ...
        className="w-full max-w-sm bg-white dark:bg-slate-900 p-6 rounded-lg shadow-2xl border border-slate-200 dark:border-slate-800 space-y-4"
      >
        <div className="border-b border-slate-100 dark:border-slate-800 pb-3 text-center">
          ...
          <p className="text-[10px] font-bold text-slate-400 uppercase mt-1">
            Secure confidential report
          </p>
        </div>

        <form onSubmit={submitFeedback} className="space-y-6">
          <div className="space-y-2">
            <label className="text-[9px] font-black uppercase tracking-widest text-slate-500 text-center block">
              Effectiveness Index
            </label>
          ...
          <div className="flex justify-end gap-2">
            ...
            <Button
              type="submit"
              isLoading={loading}
              className="bg-indigo-600 text-[10px] font-black uppercase tracking-widest h-9 px-6 shadow-sm"
            >
              Submit Feedback
            </Button>
          </div>
